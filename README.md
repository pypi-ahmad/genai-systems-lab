...
| Latency score | 0.1 | $5000 / (5000 + \text{latency}\_\text{ms})$ |
...
- `GET /leaderboard` runs all registered benchmarks live and ranks projects by $\text{score} = \text{accuracy}\, /\, \text{mean}\_\text{latency}\_\text{ms}$. Public — no API key required.
