...
export function PlaygroundGraphPanel({
  ...
  return (
    <section className="surface-card rounded-[1.75rem] p-6 sm:p-7 transition-all duration-300 ease-in-out">
      ...
      <div className="mt-7 grid gap-6 2xl:grid-cols-[minmax(0,1.12fr)_minmax(320px,0.88fr)]">
        <div className="space-y-5">
          ...
          <div className="surface-panel rounded-[1.35rem] p-5 transition-all duration-300 ease-in-out sm:p-6">
